<x-layout>
    ...
    The app is enhanced to feel like a <a href="https://en.wikipedia.org/wiki/Single-page_application" target="_blank">single-page app</a>
    ...
    <p>
    To get a better understanding which parts of the page were updated, the bar at the bottom shows which selectors were
    targeted. Click on <i>reveal</i> to highlight the fragment in the page.
    </p>
    ...
    <p>
    Throughout the app you will see <b>green dots</b> <x-tour-dot>This is a hint!</x-tour-dot>.
